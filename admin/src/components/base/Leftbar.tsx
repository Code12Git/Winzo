...
const LeftBar = () => {
	...
	return (
		<div className="bg-gradient-to-b h-screen border-r border-gray-400 hidden md:block from-slate-900 via-gray-900 to-zinc-900 opacity-90 w-56 overflow-hidden">
