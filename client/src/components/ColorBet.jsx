 ...
 return (
   <div className='p-4 md:p-20 flex flex-col'>
    ...
    <div className='flex flex-wrap gap-4 md:gap-6 justify-center md:justify-between items-center mt-6 md:mt-12'>
        <button className='bg-red-500 hover:bg-red-600 text-white font-semibold py-2 px-4 rounded-md transition duration-300'>
            <RedModal />
        </button>
        <button className='bg-green-500 hover:bg-green-600 text-white font-semibold py-2 px-4 rounded-md transition duration-300 mt-2 md:mt-0'>
            <GreenModal />
        </button>
        <button className='bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded-md transition duration-300 mt-2 md:mt-0'>
            <BlueModal />
        </button>
    </div>
</div>
